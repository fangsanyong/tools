...
# 移动训练集文件
move_files(train_files, os.path.join(output_train_folder), os.path.join(output_train_folder))

# 移动验证集文件
move_files(val_files, os.path.join(output_val_folder), os.path.join(output_val_folder))
